...
- [x] Phase 4: [FFI Functions](4-ffi-functions/spec.md) - Surface creation/ops, tray functions, canvas functions
- [x] Phase 5: [Examples and CI](5-examples-and-ci/spec.md) - C examples, CMake/build.bat, CI header check, .def file, progress update
