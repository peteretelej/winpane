...
- [ ] Phase 3: [Engine Integration](3-engine-integration/spec.md) - PiP surface creation with DWM thumbnails, anchor positioning, monitor event processing, PiP guards on existing handlers
- [ ] Phase 4: [Public API and FFI](4-public-api-and-ffi/spec.md) - Pip struct, anchor_to/unanchor/set_capture_excluded on all surfaces, 6 new FFI functions, C types, .def file
